...
> - `ui/handlers/review_handler.py` exists
> - `utils/git_ops.py` and `utils/diff_parser.py` exist
> - `ui/views/review_bar.py` and `ui/views/diff_card.py` exist
> - Note: Project Feed (PROJECT_FEED.md) has superseded the original session-based review workflow
