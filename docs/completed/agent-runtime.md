...
> **Status: IMPLEMENTED** — All phases (1.1–1.5) built. `agent/runtime.py`, `agent/tools.py`, `agent/config.py`, `agent/context.py`, `agent/special_agents.py` all exist and match spec. Note: `system_prompt_template` field removed from `SpecialAgentDef` (dead code cleanup).
