...
> **Status: IMPLEMENTED** — Verified in code as of 2026-05-09. Phases 1-4, 6-7 of BUILD_ORDER.md completed. Only §4.9 (graduated compaction) remains.
> - `coder.md` rewritten with enhanced tool strategy, edit_file instructions
> - `debugger.md` enhanced
> - `agent/tools.py` has detailed tool descriptions
> - `agent/special_agents.py` cleaned up (no `system_prompt_template`)
