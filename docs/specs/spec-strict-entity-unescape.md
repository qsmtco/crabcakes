...
- `tests/test_markdown.py` (full, 317 lines) — confirmed no existing test covers the full `escape_for_pango` → `format_markdown` pipeline with auto-link input that produces malformed entities.
